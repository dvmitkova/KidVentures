  ...
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-44 sm:py-72">
      ...
      <div className="flex justify-center items-start h-full">
        <div className="absolute top-20 left-0 right-0 mx-auto max-w-3xl bg-yellow-100 bg-opacity-40 rounded-lg text-center">
          <h2 className="text-3xl font-bold text-cyan-800 sm:text-6xl">Travel with your kids</h2>
          <p className="text-2x1 mt-6 font-bold leading-8 text-cyan-900">
